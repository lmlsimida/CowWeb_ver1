...
def check_quest(request):
    ...
    user_agent = request.META.get("HTTP_USER_AGENT", "pc")
    # userAgent = env.get('HTTP_USER_AGENT')
    _long_matches = r"googlebot-mobile|android|avantgo|blackberry|blazer|elaine|hiptop|ip(hone|od)|kindle|midp|mmp|mobile|o2|opera mini|palm( os)?|pda|plucker|pocket|psp|smartphone|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce; (iemobile|ppc)|xiino|maemo|fennec|WindowsWechat"
...
class DateJsonEncoder(json.JSONEncoder):
    def default(self, obj):
        if isinstance(obj, datetime.datetime):
            s_t = obj.strftime("%Y-%m-%dT%H:%M:%S.%f").strip("0")
            return {"$date": s_t + "Z"}
...
area = {
    ...
    "河南省": {
        ...
        "开封市": ["市辖区", "龙亭区", "顺河回族区", "鼓楼区", "禹王台区", "祥符区", "杞县", "通许县", "尉氏县", "兰考县"],
        "洛阳市": [
            "市辖区",
            "老城区",
            "西工区",
    ...
    "广东省": {
        ...
        "深圳市": ["市辖区", "罗湖区", "福田区", "南山区", "宝安区", "龙岗区", "盐田区", "龙华区", "光明新区"],
        "珠海市": ["市辖区", "香洲区", "斗门区", "金湾区"],
    ...
    "广西壮族自治区": {
        ...
        "贺州市": ["市辖区", "八步区", "平桂管理区", "昭平县", "钟山县", "富川瑶族自治县"],
        "河池市": [
            "市辖区",
            "金城江区",
            "南丹县",
    ...
    "陕西省": {
        ...
        "安康市": ["市辖区", "汉阴县", "石泉县", "宁陕县", "紫阳县", "岚皋县", "平利县", "镇坪县", "旬阳县", "白河县"],
    ...
    "青海省": {
        ...
        "海东市": ["市辖区", "乐都区", "平安县", "民和回族土族自治县", "互助土族自治县", "化隆回族自治县", "循化撒拉族自治县"],
    ...
    "新疆维吾尔自治区": {
        ...
        "自治区直辖县级行政区划": ["石河子市", "阿拉尔市", "图木舒克市", "五家渠市", "北屯市", "铁门关市", "双河市"],
    },
    "台湾省": {
        "台北市": [
            "松山区",
